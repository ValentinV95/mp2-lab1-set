...
TEST(TBitField, cannot_create_bitfield_with_zero_length)
{
    ASSERT_ANY_THROW(TBitField bf(0));
}

TEST(TBitField, cannot_create_bitfield_with_negative_length)
{
...
TEST(TBitField, and_operator_applied_to_bitfields_of_non_equal_size)
{
  ...
  TBitField bf1(size2), bf2(size1), expBf(size2);
  // bf2 = 0011
  bf2.SetBit(0);
  bf2.SetBit(1);
  // bf1 = 01010
